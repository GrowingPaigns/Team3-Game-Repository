...
namespace Team_3_Project__menu_
{
    ...
    {
        //(Pretty much everything will need these)
        ...
        //Most actual game stuff will be defined within GameState
        Color color;
        ...
        public Game1()
        {
            ...
            //Makes graphics high def, dont think this is currently needed, old code from sheet experimentation
        ...
        {
            //Initializes + applies screen height
        ...
        {
            //Plain BG, little nicer than cornflowerblue
