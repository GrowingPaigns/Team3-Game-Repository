...
namespace Team_3_Project__menu_.States
{
    public class MenuState : State
    {
        ...
        public override void LoadContent()
        {
            ...
            //Sam - Loads Menu Song (need to make it not start over everytime MenuState is triggered, and need to make it loop indefinitely (otherwise functional))
            ...
            //Sam - loads in sprite sheet (for some reason my spritesheet origin is at its very top left corner, which will mean this is loaded at (0,0) rather than center screen
            player = new VidPlayer(new Vector2(0, 0));
            //Sam - loads in the texture from Player.cs
            ...
            _components = new List<Component>()
            {
                ...
                //Sam - Currently these sprites are defined as Buttons because i wanted to get the menu to yall, I will change this at a later point once I create a gen. Sprite class
                //Sam - Loads Button texture and font as well as position and what happens if you click the Button
                new Sprite(topBorder)
                {
                ...
                //Sam - Actual buttons Which send to different States (options currently not functional, 
                //Sam - using an unimplemented method, will change at a later point incorporating sounds and music volume changer)
        ...
        //Sam - Details the event of changing state
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            //Sam - Example of Drawing a list such as (somewhat) described in GameState
        ...
        //Sam - Same List example which helps clean up everything (high lvl code which I dont even fully understand, dont feel like you have to use lists)
        ...
        {
            //Sam - remove sprites if they're not needed
        }
